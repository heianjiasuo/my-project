            ...
            <div class="panel-body">
                ...
                <div id="toolbar">
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">是否领养</div>
...
<script>
    ...
    $('#table').bootstrapTable({
        ...
        columns: [{
            ...
            formatter: function (value, row, index) {
                ...
                var btn4 = '<a style="margin-left: 10px" class="btn btn-warning"  href="petEditor?id='+row.id+'">报道</a>';
                var btn5 = '<button style="margin-left: 10px" class="btn btn-danger " onclick="addFeeder('+row.id+')">领养</button>';
    ...
    function addFeeder(id) {
        ...
        layer.confirm('确定要领养id为：'+id+'的宠物吗？', {
            btn: ['确定','取消'] //按钮
        }, function(){
            $.ajax({
                type: "post",
