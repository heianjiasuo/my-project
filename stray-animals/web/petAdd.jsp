...
<%--                                    <th>发布时间：</th>--%>
<%--                                    <td>--%>
<%--                                        <input type="text" disabled name="createTime"  min="1900-01-01" max="2018-04-12" class="common-text">--%>
<%--                                    </td>--%>
<%--                                </tr>--%>
<%--                                <tr>--%>
<%--                                    <th>所属机构：</th>--%>
<%--                                    <td>--%>
<%--                                        <input class="common-text" disabled name="organization"  size="50" type="text">--%>
<%--                                    </td>--%>
<%--                                </tr>--%>
<%--                                <tr>--%>
<%--                                    <th>饲主：</th>--%>
